...
def main():
    parser = argparse.ArgumentParser(description="Train pure Transformer on seq6 without physics constraints")
    ...
    parser.add_argument("--model_out", default="/home/evawang/T-GCN/data/auv_pure_tf_seq6_model.pt")
    parser.add_argument("--history_out", default="/home/evawang/T-GCN/data/auv_pure_tf_seq6_history.csv")
    parser.add_argument("--curve_out", default="/home/evawang/T-GCN/data/auv_pure_tf_seq6_loss_curve.png")
    ...
    plt.xlabel("Epoch")
    plt.ylabel("RMSE")
    plt.title("Pure Transformer Training Curve (RMSE vs Epoch)")
    plt.grid(True)
    plt.legend()
    plt.tight_layout()
